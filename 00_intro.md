...
{{quote {author: Edsger Dijkstra", title: "Close to the Machine: Technophilia and Its Discontents", chapter: true}
...
جولیا زبان نسبتاً جوانی است که اولین بار در سال ۲۰۱۲ پس از تلاش‌های دو ساله و نیمه یک گروه از محققین در دانشگاه MIT به وجود آمد و عرضه عمومی شد.
